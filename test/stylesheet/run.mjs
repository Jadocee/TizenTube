...
async function run(file) {
  ...
  return page.evaluate(() => ({ ...window.__result, styleCount: window.__ttBlocks, sheetText: window.__ttSheetText }));
}
...
check('a theme update replaces rather than stacks', (after.sheetText.match(/tt-theme/g) || []).length, 0);
