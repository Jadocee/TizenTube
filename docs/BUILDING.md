...
| Chromium | any recent | only for the seven browser harnesses. Without it they *skip*, which is fine locally and a failure in CI |
...
Seven harnesses drive real Chromium through Playwright and two of those also need
